...
import { HttpResponse, EmailValidator, AddAccount, AddAccountModel, AccountModel } from './signup-protocols'
...
describe('SignUp Controller', () => {
  ...
  test('Should return 200 when valid data is provided to AddAccount', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'valid_name',
